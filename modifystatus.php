			...
			<body>
				<div class="wrapper">
			  						...
			  						<div class="navbar-right" >
											<ul class="nav navbar-nav">
										            ...
										            <li class="divider-vertical" style="height: 50px; border-left: 1px solid orange; opacity: 0.5; margin: 0 23px;">
										              <a class="nav-link" href="#about" style="color: #000000"><span class="glyphicon glyphicon-bell" style="color:orange; font-size: 20px"></span> Notifications</a>
										            </li>
										            <li class="divider-vertical" style="height: 50px; border-left: 1px solid orange; opacity: 0.5; margin: 0 -18px;">
										              <a class="nav-link" href="#speakers" style="color: #000000"><span class="glyphicon glyphicon-envelope" style="color:orange; font-size: 20px"></span> Messages</a>
										            </li>
						...
						<div class="panel panel-default" >
						  <div class="panel-body" style="padding-top: 50px; height:auto; margin-left: 300px; background-color: #FBFBFB ; ">
							...
							?> 
									...
									if($action=='addpdetails'){
									 ?>
											...
											?>
											<a  class="btn btn-primary pull-right" href="?action=statusdetails">VIEW IMPL STATUS DETAILS</a>
									...
									<!-- Action status details-->
								              ...
								              <table class="table table-striped table-hover">
								                <tr style="background: #ffc266">
								                  ...
								                  <th style="color: white">ACTION</th>
													...
													$sql="select * from implementation_status";
									                 $result=mysqli_query($connection,$sql);
									                  ...
									                  while($rows=mysqli_fetch_array($result))
									                {
									                  ...
									                  $Proj_code=$rows['Proj_code'];
									                  $Impl_code=$rows['Impl_code'];
									                  $Impl_status=$rows['Impl_status'];
									                  $Proj_status=$rows['Proj_status'];
									                  $Remarks=$rows['Remarks'];
									                  $Action_required=$rows['Action_required'];
									  
									                  echo("<tr>");
									                  echo("<td>$Proj_code</td>");
									                  echo("<td>$Impl_code</td>");
									                  echo("<td>$Impl_status</td>");
									                  echo("<td>$Proj_status</td>");
									                  echo("<td>$Remarks</td>");
									                  echo("<td>$Action_required</td>");
									                  echo("<td><a  class='btn btn-primary' href='modifystatus.php?Proj_code=$Proj_code'>UPDATE</a></td>");
									                  echo("</tr>");}?>
											...
											include('connection.php');
									         ...
									         while($fetch=mysqli_fetch_array($result)){?>
									         	<h2><center>UPDATE STATUS DETAILS</center></h2>
													<form method="post">
															<h4>
														<table class="table hover" >
													  <tr>
													    <td>Project Code</td>
													    <td><input type="hidden" name="pcode" required class="form-control" value="<?php echo $fetch['Proj_code']; ?>" /><b style="color: orange"><?php echo $fetch['Proj_code']; ?></b></td>     
													    <td>Implementation code</td>
													  ...
													  <tr>
													    ...
													    <td>&nbsp;</td>
													    <td>&nbsp;</td>
													    <td><input type="submit" value="SUBMIT" name="isub" class="form-control btn-primary pull-right" style="width: 100px;"/></td>
													  </tr>
												 </table>
												 </h4>
												 </form>
												...
												if($run_sql){
												echo "<script>alert('Status updated successfully'); window.location='home.php?action=statusdetails'</script>";

												}else {
												echo "<script>alert('Error ! Failed to update'); window.location='home.php?action=statusdetails'</script>";
