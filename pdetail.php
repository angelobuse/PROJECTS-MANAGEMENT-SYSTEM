									...
									if($action=='addpdetails'){
									 ?>
												...
												$pscope=trim($_POST ['pscope']);
												 ...
												 $impstartdate=trim($_POST ['impstartdate']);
										...
										<!--Action Implementation Status Details-->
											<?php 
												      ...
												      <div class="modal-body">
												        <form role="form" action="edituser.php" method="post">
												            ...
												            <table class="table table table-hover table-condensed">
																<tr>
																    <td>User ID</td>
																    <td><input type="text" name="user_id"   required class="form-control" value="<?php echo $rows['user_id']; ?>" disabled/></td>
																</tr>
																<tr>
																    <td>Names</td>
